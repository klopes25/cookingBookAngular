...
describe('FiltersComponent', () => {
  ...
  it('should change min and max spices filters', () => {
    ...
    // min >= 0 && max <= 3 && min < max
    let inputMin = fixture.debugElement.query(By.css('.icon-extinguisher input.min'));
    inputMin.nativeElement.value = "1";
    let inputMax = fixture.debugElement.query(By.css('.icon-extinguisher input.max'));
  ...
  it('should change min and max stars filters', () => {
    ...
    // min >= 0 && max <= 5 && min < max
    let inputMin = fixture.debugElement.query(By.css('.icon-star input.min'));
    inputMin.nativeElement.value = "1";
    let inputMax = fixture.debugElement.query(By.css('.icon-star input.max'));
    inputMax.nativeElement.value = "2";
